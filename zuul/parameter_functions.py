...
dependencies = {
    ...
    'BlueSpiceCategoryManager': ['BlueSpiceFoundation', 'BlueSpiceExtensions'],
    'BlueSpiceEditNotifyConnector': ['BlueSpiceFoundation'],
    'BlueSpiceExtendedFilelist': ['BlueSpiceFoundation'],
    'BlueSpiceExtendedSearch': ['BlueSpiceFoundation', 'BlueSpiceExtensions'],
    'BlueSpiceExtendedStatistics': ['BlueSpiceFoundation', 'BlueSpiceExtensions'],
    ...
    'BlueSpicePageAssignments': ['BlueSpiceFoundation', 'BlueSpiceExtensions'],
