...
dependencies = {
    ...
    'BlueSpiceSocialArticleActions': ['BlueSpiceFoundation'],
    'BlueSpiceSocialBlog': ['BlueSpiceFoundation'],
    'BlueSpiceSocialComments': ['BlueSpiceFoundation'],
    'BlueSpiceSocialMicroBlog': ['BlueSpiceFoundation'],
    'BlueSpiceSocialProfile': ['BlueSpiceFoundation'],
    'BlueSpiceSocialRating': ['BlueSpiceFoundation'],
    'BlueSpiceSocialResolve': ['BlueSpiceFoundation'],
    'BlueSpiceSocialTags': ['BlueSpiceFoundation'],
    'BlueSpiceSocialTimelineUpdate': ['BlueSpiceFoundation'],
    'BlueSpiceSocialTopics': ['BlueSpiceFoundation'],
    'BlueSpiceSocialWatch': ['BlueSpiceFoundation'],
    'BlueSpiceSocialWikiPage': ['BlueSpiceFoundation'],
