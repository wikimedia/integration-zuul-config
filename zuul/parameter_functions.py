...
dependencies = {
    ...
    'extensions/CirrusSearch': ['extensions/MwEmbedSupport', 'extensions/TimedMediaHandler',
                     'extensions/PdfHandler', 'Cite'],
    'extensions/CodeEditor': ['extensions/WikiEditor'],
    'extensions/CollaborationKit': ['extensions/EventLogging', 'extensions/VisualEditor'],
    'extensions/ContentTranslation': ['extensions/Echo', 'extensions/EventLogging', 'extensions/GuidedTour',
                           'extensions/GuidedTour', 'extensions/UniversalLanguageSelector',
                           'extensions/Wikidata'],
    ...
    'extensions/EducationProgram': ['extensions/cldr', 'extensions/WikiEditor'],
    ...
    'extensions/GettingStarted': ['extensions/CentralAuth', 'extensions/EventLogging', 'extensions/GuidedTour'],
    'extensions/Graph': ['extensions/CodeEditor', 'extensions/JsonConfig', 'extensions/VisualEditor'],
    'extensions/GuidedTour': ['extensions/EventLogging'],
    'extensions/GWToolset': ['extensions/SyntaxHighlight_GeSHi', 'extensions/Scribunto', 'extensions/TemplateData'],
    'extensions/ImageMetrics': ['extensions/EventLogging'],
    'extensions/Kartographer': ['extensions/ParserFunctions', 'extensions/VisualEditor', 'extensions/WikimediaMessages'],
    ...
    'extensions/MobileApp': ['extensions/Echo', 'extensions/MobileFrontend', 'extensions/VisualEditor'],
    'extensions/MobileFrontend': ['extensions/Echo', 'extensions/VisualEditor', 'extensions/ZeroBanner', 'extensions/MobileApp'],
    ...
    'extensions/PhpTagsStorage': ['extensions/PhpTags', 'extensions/PhpTagsFunctions', 'extensions/PhpTagsWiki',
                       'extensions/PhpTagsWidgets'],
    'extensions/PhpTagsWidgets': ['extensions/PhpTags', 'extensions/PhpTagsFunctions', 'extensions/PhpTagsWiki'],
    'extensions/PhpTagsWiki': ['extensions/PhpTags', 'extensions/PhpTagsFunctions'],
    'extensions/PictureGame': ['extensions/SocialProfile'],
    'extensions/PollNY': ['extensions/SocialProfile'],
    'extensions/Popups': ['extensions/BetaFeatures', 'extensions/TextExtracts', 'extensions/PageImages'],
    'extensions/PronunciationRecording': ['extensions/UploadWizard'],
    'extensions/ProofreadPage': ['extensions/LabeledSectionTransclusion', 'extensions/VisualEditor'],
    'extensions/QuickSurveys': ['extensions/EventLogging'],
    'extensions/Ratings': ['extensions/Validator'],
    'extensions/RelatedArticles': ['extensions/BetaFeatures', 'extensions/Cards', 'extensions/MobileFrontend'],
    ...
    'extensions/Translate': ['extensions/UniversalLanguageSelector', 'extensions/EventLogging', 'extensions/cldr'],
    ...
    'extensions/UploadWizard': ['extensions/WikimediaMessages', 'extensions/EventLogging'],
    ...
    'extensions/Wikibase': ['extensions/CirrusSearch', 'extensions/cldr', 'extensions/Elastica', 'extensions/GeoData',
                 'extensions/Scribunto', 'extensions/Capiunto'],
    ...
    'extensions/WikibaseQualityConstraints': ['extensions/Wikibase', 'extensions/WikibaseQuality'],
    'extensions/WikibaseQualityExternalValidation': ['extensions/Wikibase', 'extensions/WikibaseQuality'],
    ...
    'extensions/ZeroBanner': ['extensions/Echo', 'extensions/JsonConfig', 'extensions/MobileFrontend', 'extensions/VisualEditor',
                   'extensions/ZeroPortal'],
    'extensions/ZeroPortal': ['extensions/Echo', 'extensions/JsonConfig', 'extensions/MobileFrontend', 'extensions/Scribunto',
                   'extensions/VisualEditor', 'extensions/ZeroBanner'],
}
