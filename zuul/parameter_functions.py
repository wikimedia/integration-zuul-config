...
dependencies = {
    ...
    'extensions/CirrusSearch': ['extensions/MwEmbedSupport', 'extensions/TimedMediaHandler', 'extensions/PdfHandler',
                     'Cite'],
    ...
    'extensions/ContentTranslation': ['extensions/Echo', 'extensions/EventLogging', 'extensions/GuidedTour',
                           'extensions/UniversalLanguageSelector', 'extensions/Wikidata'],
    ...
    'ZeroPortal': ['extensions/Echo', 'extensions/JsonConfig', 'extensions/MobileFrontend', 'extensions/Scribunto',
                   'extensions/VisualEditor', 'ZeroBanner'],
}
