...
def stats = [
  [["job", jobName, project], 1, "c"],
  [["job", jobName, project], duration, "ms"],
  [["node", node, "job", jobName, project], 1, "c"],
  [["node", node, "job", jobName, project], duration, "ms"],
]

labels.each { label ->
  stats.add([["label", label, "job", jobName, project], 1, "c"])
  stats.add([["label", label, "job", jobName, project], duration, "ms"])
}
