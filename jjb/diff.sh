...
echo " File changed"
echo "--------------------------------------------"
(diff --brief "$test_dir"/output-parent "$test_dir"/output-proposed || : ) | $CDIFF_BIN -c always


echo "--------------------------------------------"
echo " Full diff"
echo "--------------------------------------------"
(diff --new-file -u "$test_dir"/output-parent "$test_dir"/output-proposed || : ) | $CDIFF_BIN -c always
echo "Done."
