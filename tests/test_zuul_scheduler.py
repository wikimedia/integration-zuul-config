...
class TestZuulScheduler(unittest.TestCase):
    ...
    def test_mediawiki_release_repos_are_in_sync(self):
        self.longMessage = True
        self.maxDiff = None
        ...
        execfile(os.path.join(
            ...
            '../zuul/parameter_functions.py'),
            global_env)
        release_repos = sorted(global_env['release_repos'])

        # Get projects having a 'release-quibble-*' job
